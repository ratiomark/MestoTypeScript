...
import { Section } from "./scripts/Section.ts";
import { PopupWithForm } from "./scripts/PopupWithForm.js";
import { PopupWithImage } from './scripts/PopupWithImage.ts';
...
const createNewCard = (cardData, templateSelector, handleCardClick, setLike, unsetLike, myId, handleRemoveCard) => {
